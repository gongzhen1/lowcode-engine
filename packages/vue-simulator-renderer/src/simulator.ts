import { DocumentModel } from '@felce/lowcode-designer';
import { IPublicEnumTransformStage } from '@felce/lowcode-types';
import { AssetLoader } from '@felce/lowcode-utils';
...
import { buildComponents, getSubComponent } from './utils/build-components';
...
function createSimulatorRenderer() {
  ...
  function _buildComponents() {
    components.value = {
      ...builtinComponents,
      ...buildComponents(libraryMap.value, componentsMap.value, simulator.createComponent),
    };
  }
