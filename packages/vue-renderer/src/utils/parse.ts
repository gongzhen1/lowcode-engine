import { IPublicTypeI18nData, JSExpression, JSFunction } from '@felce/lowcode-types';
import { isI18nData, isJSExpression, isJSFunction, isPlainObject } from '@felce/lowcode-utils';
...
export function parseI18n(i18nInfo: IPublicTypeI18nData, scope?: RuntimeScope) {
...
export function parseSchema(schema: IPublicTypeI18nData, scope?: RuntimeScope): string | undefined;
