...
import { PropType, Component, ComponentPublicInstance, h, computed, defineComponent } from 'vue';
...
interface RendererProps {
  ...
  onCompGetCtx?: (schema: IPublicTypeNodeSchema, ref: ComponentPublicInstance) => void;
}
...
const Renderer = defineComponent({
  ...
  setup(props: RendererProps) {
    const triggerCompGetCtx = (schema: IPublicTypeNodeSchema, val: ComponentPublicInstance) => {
